...
const CODES = ["ENG","BRA","FRA","ARG","MAR","MEX","USA","GER","ESP","POR","NED","BEL","CRO","SCO","NOR","JPN","KOR","IRQ","URU","COL"];
const curve = new ethers.Contract(CURVE_V2, CURVE_ABI, ethers.provider);
